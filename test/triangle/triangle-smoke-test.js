...
describe('Triangle smoke test', function() {
    ...
    it('Triangle method with no spec should return object', function() {
   ...
   it('cloneArray method should return a clone of the internal array', function() {
    ...
    it('getNeighborDirs should return correct lists', function() {
        var grid = _module.Triangle({ x: 5, y: 5 });
        assert.ok(grid != null);
        assert.deepStrictEqual(grid.getNeighborDirs(1,1), [ "S", "E", "W" ]);
        assert.deepStrictEqual(grid.getNeighborDirs(2,1), [ "N", "E", "W" ]);
    });
    ...
    it('getShuffledNeighborDirs should return shuffled list', function() {
        ...
        assert.deepStrictEqual(shuffled.length, 3);
